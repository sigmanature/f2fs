...
static inline size_t f2fs_ifs_iomap_longs(const struct folio *folio)
{
	...
	unsigned int nr_blocks = i_blocks_per_folio(inode, (struct folio *)folio);
...
f2fs_ifs_private_flags_ptr(struct f2fs_iomap_folio_state *fifs, const struct folio *folio)
{
